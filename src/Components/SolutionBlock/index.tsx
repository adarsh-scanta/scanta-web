...
const SolutionBlock = ({ t, from }: any) => {
  ...
  return (
    <LeftContentSection>
      {from === "home" ? <Row justify="space-evenly" align="middle">
        ...
        <Col lg={12} md={12} sm={12} xs={24}>
          <ContentWrapper>
            <AboutHeading><span style={{ color: "#430568" }}>Privacy & Security</span> by Design</AboutHeading>
            <Content>
              <ContentWrapper
                style={{
              ...
              >
                ...
                <AboutContent
                  style={{ color: mouseOver === "Private" ? "#FFF" : "" }}
                >
                  Organizational or Group Level Insights<br />
      ...
      </Row> : <Row justify="space-evenly" align="middle">
        <Col lg={12} md={12} sm={12} xs={24}>
          <ContentWrapper>
            <AboutHeading><span style={{ color: "#430568" }}>Privacy & Security</span> by Design</AboutHeading>
            <Content>
              ...
              >
                ...
                >
                  Leading cloud security to protect your data<br/>
                  Transactional security on each interaction<br/>
              ...
              >
                ...
                <AboutContent
                  style={{ color: mouseOver === "Secure" ? "#FFF" : "" }}
                >
                  Align with your privacy policy<br/>
                  Analyse the demographics that are important to you<br/>
