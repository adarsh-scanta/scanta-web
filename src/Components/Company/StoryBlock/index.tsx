      ...
      <Container>
        ...
        <Row justify="center" id={id}>
          <ContentWrapper>
            ...
            <Content>
              Meet our team of passionate entrepreneurs, seasoned business executives and technical visionaries. Together the worldwide Scanta team is looking to uncover, develop and deploy solutions to enhance the use of AI technology.
            </Content>
          </ContentWrapper>
        </Row>
        {/* </Fade> */}
          ...
          <Col lg={8} md={8} sm={22} xs={22}>
            ...
            <div style={{ padding: "1.5rem 0 0" }}>
              ...
              <Content>
                ...
                <br />
                <span style={{ fontSize: "1.1rem" }}>Co-Founder</span>
              </Content>
              {/* </Fade> */}
            </div>
            {/* </Fade> */}
          ...
          <Col lg={8} md={8} sm={22} xs={22}>
            <div>
              ...
              <Content>
                ...
                <br />
                <span style={{ fontSize: "1.1rem" }}>CRO</span><br />
                <span style={{ fontSize: "1.1rem" }}>Co-Founder</span>
              </Content>
              {/* </Fade> */}
            </div>
